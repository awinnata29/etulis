<aside class="side-promotion side-promotion-left" aria-label="Promosi">
 ...
 <a href="https://akundigital.id" target="_blank" rel="noopener sponsored">
  <img src="{{ asset('images/ads/ads1.png') }}" alt="Promosi AkunDigital" width="758" height="2075">
 </a>
</aside>
<aside class="side-promotion side-promotion-right" aria-label="Promosi">
 <span>Promosi</span>
 <a href="https://akundigital.id" target="_blank" rel="noopener sponsored">
  <img src="{{ asset('images/ads/ads2.png') }}" alt="Promosi AkunDigital" width="758" height="2075">
 </a>
</aside>
<aside class="inline-promotions wrap" aria-label="Promosi">
 ...
 <div class="inline-promotion-list">
  <a href="https://akundigital.id" target="_blank" rel="noopener sponsored"><img src="{{ asset('images/ads/ad1.png') }}" alt="Promosi AkunDigital" width="2172" height="724" loading="lazy"></a>
  <a href="https://akundigital.id" target="_blank" rel="noopener sponsored"><img src="{{ asset('images/ads/ad2.png') }}" alt="Promosi AkunDigital" width="2172" height="724" loading="lazy"></a>
 </div>
</aside>
